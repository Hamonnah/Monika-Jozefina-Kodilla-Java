...
public class CrudAppTesting {

    public static final String XPATH_INPUT = "//html/body/main/section/form/fieldset/input";
    public static final String XPATH_TEXTERA = "//html/body/main/section/form/fieldset[2]/textarea";
    ...
    public static void main(String[] args) {
        ...
        driver.get("https://hamonnah.github.io/");

        WebElement searchField = driver.findElement(By.xpath(XPATH_INPUT));
        searchField.sendKeys("New robotic task");

        WebElement textareaField = driver.findElement(By.xpath(XPATH_TEXTERA));
